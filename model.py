...
def createNetwork(hidden_size, out_vertices):
    ...
    model.add(layers.Dense(hidden_size, activation='relu', bias_initializer='ones', kernel_initializer='ones'))
    model.add(layers.Dense(3 * out_vertices, activation='relu', bias_initializer='ones', kernel_initializer='ones'))
